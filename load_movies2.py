...
def add_movie(movie_id):
    ...
    headers = {
        ...
        "Authorization": f"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxZWZiZmJjMjE0ZDE1OTJmOTMxZmZlODhkMmE5ODZmZiIsInN1YiI6IjY1MmVmN2Q4Y2FlZjJkMDBlMjhkMjE4MyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.l5wK5DzgiWhwy92NYWodwhtk58LP4btE_akWHL6kW-U"}
    ...
    conn = psycopg2.connect("dbname=moviesproyect user=postgres password=LalinPinguin1034")
    cur = conn.cursor()
